 ...
 * Use the [DanceReadFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class DanceReadFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment DanceReadFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
                DanceReadFragment().apply {
