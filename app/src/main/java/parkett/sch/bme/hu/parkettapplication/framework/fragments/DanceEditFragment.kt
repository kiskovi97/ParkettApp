 ...
 * Use the [DanceEditFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class DanceEditFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment DanceEditFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
                DanceEditFragment().apply {
