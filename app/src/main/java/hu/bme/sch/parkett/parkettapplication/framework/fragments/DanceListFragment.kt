 ...
 * Use the [DanceListFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class DanceListFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment DanceListFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
                DanceListFragment().apply {
